...
import com.example.myapplication.ble.manager.BLEManager;
import com.example.myapplication.ble.manager.OnBleConnectListener;
import com.example.myapplication.ble.manager.OnDeviceSearchListener;
import com.example.myapplication.ble.permission.PermissionListener;
import com.example.myapplication.ble.permission.PermissionRequest;
import com.example.myapplication.ble.util.TypeConversion;
...
public class BleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        } else if (viewId == R.id.bt_disconnect) {  // 断开连接
            if (curConnState) {
                if (bleManager != null) {
        ...
        } else if (viewId == R.id.bt_to_send) {  // 发送数据
            if (curConnState) {
